...
System.register("chunks:///_virtual/demo15.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './index.ts', './yx-collection-view.ts', './yx-flow-layout.ts', './yx-types.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Prefab, NodeEventType, director, instantiate, Node, math, randomRangeInt, Sprite, Component, YXCollectionView, YXFlowLayout, YXEdgeInsets;
...
System.register("chunks:///_virtual/Demo15Cell1.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './index.ts', './yx-collection-view.ts', './yx-masonry-flow-layout.ts', './yx-flow-layout.ts', './yx-types.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Prefab, instantiate, Label, randomRangeInt, Sprite, math, log, Component, YXCollectionView, YXMasonryFlowLayout, YXFlowLayout, YXEdgeInsets;
...
System.register("chunks:///_virtual/Demo15Cell2.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './index.ts', './yx-collection-view.ts', './yx-flow-layout.ts', './yx-types.ts', './yx-cover-layout.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Prefab, instantiate, Node, UITransform, Label, randomRangeInt, Sprite, math, Component, YXCollectionView, YXFlowLayout, YXEdgeInsets, YXCoverLayout;
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './demo1.ts', './demo10.ts', './demo11.ts', './demo12.ts', './demo13.ts', './demo14.ts', './Demo15Cell1.ts', './Demo15Cell2.ts', './demo15.ts', './demo2.ts', './demo3.ts', './demo4.ts', './demo5.ts', './demo6.ts', './demo7.ts', './demo8.ts', './demo9.ts', './home.ts', './index.ts', './yx-collection-view.ts', './yx-cover-layout.ts', './yx-flow-layout.ts', './yx-masonry-flow-layout.ts', './yx-types.ts'], function () {
  return {
    ...
    execute: function () {
      ...
      var _scroll_view = /*#__PURE__*/function (_ScrollView) {
        ...
        function _scroll_view() {
          ...
          _this2._yxOnStartInertiaScroll = void 0;
          return _this2;
        }
        ...
        _proto._yxGetScrollTarget = function _yxGetScrollTarget(event, captureListeners) {
          // 尝试获取本次已经确定了的滚动节点
